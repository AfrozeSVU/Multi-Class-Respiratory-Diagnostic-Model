...
def extract_features(audio_data, sr, n_mfcc, max_len):
    ...
    return mfccs  # Returns (N_MFCC, MAX_MFCC_LENGTH)
...
if __name__ == '__main__':
    ...
    if len(y_true) == 0:
        print("[ERROR] No valid predictions were made. External validation failed.")
        exit()
    ...
    print("Class Order (for Matrix):", CLASS_LABELS)
    print(conf_matrix)
